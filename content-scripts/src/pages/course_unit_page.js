...
import { groupSectionTitleAndContent, makeTextNodesElements, removeTwoColumnTable } from "../modules/utilities/pageUtils";
...
export const courseUnitPage = () => {
    ...
    groupSectionTitleAndContent("#conteudoinner", ["se-card", "se-expandable-card"]);
