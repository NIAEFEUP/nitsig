const Header = () => (
  <header className="text-center">
    <div className="flex items-center justify-center">
      <img src="./logo-extended.png" alt="NitSig Logo" className="h-16 pt-2 dark:hidden" />
      <img src="./logo-extended-white.png" alt="NitSig Logo" className="hidden h-16 pt-2 dark:block" />
    </div>
