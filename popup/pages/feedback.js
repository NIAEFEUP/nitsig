...
const FORMS_LINK =
    "https://docs.google.com/forms/d/e/1FAIpQLSdvLEl7FzXEtcq-ZeD1Lrm_1S-CTmCBc3-_AwXmWAw1LU3Z9A/formResponse";
            ...
            <main className="flex flex-col p-2 gap-y-4">
                <div className="flex justify-center gap-0">
                    <button
                        ...
                        className={
                            "font-semibold px-4 py-2 rounded-l-3xl transition-colors duration-200 " +
                            (bugReport
                    ...
                    <button
                        ...
                        className={
                            "font-semibold px-4 py-2 pr-6 rounded-r-3xl transition-colors duration-200 " +
                            (!bugReport
                                ? "bg-bgTwo dark:bg-bgTwoDark text-accentOne dark:text-accentOneDark dark:text-opacity-60"
                                : "bg-accentThree text-white ")
                        }
                ...
                <label className="flex flex-col gap-1 text-sm font-bold dark:text-accentOneDark text-accentOne">
                    ...
                    <input
                        type="text"
                        className="w-full px-4 py-3 text-[15px] font-semibold border border-transparent shadow-sm focus:outline-none dark:bg-bgTwoDark bg-bgTwo rounded-2xl dark:placeholder-accentOneDark dark:placeholder-opacity-60"
                ...
                <label className="flex flex-col gap-1 text-sm font-bold dark:text-accentOneDark text-accentOne">
                    Descrição
                    <textarea
                        className="min-h-[8em] w-full px-4 py-3 text-[15px] font-semibold border border-transparent shadow-sm focus:outline-none dark:bg-bgTwoDark bg-bgTwo rounded-2xl dark:placeholder-accentOneDark dark:placeholder-opacity-60"
