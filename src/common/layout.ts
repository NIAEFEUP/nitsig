export function groupSectionTitleAndContent(selector: string) {
...
export function moveChildrenToAncestor(selector: string) {
...
export function removeTwoColumnTable(tableSelector: string, inverted = false) {
...
export function groupChildrenBySelector(
